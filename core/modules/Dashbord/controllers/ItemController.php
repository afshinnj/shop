...
class ItemController extends Controller
{
    ...
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => Categorys::find()->where(['user_id' => Yii::$app->user->id,'state'=>  Categorys::$ITEM_STATE]),
        ]);
     ...
     * If creation is successful, the browser will be redirected to the 'view' page. && $model->save()
     * @return mixed
     */
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['/categoryItem']);
        } else {
